    ...
    >
        <div className="font-medium w-full">
            <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
                ...
                >
                    <div className="font-medium w-full mb-1 cursor-pointer">
                        <InputBox
                            label="From"
                            amount={amount}
                    ...
                    <button type="submit" className=" w-30  text-white px-4 py-3 rounded-lg border-solid border-2 border-gray-200 ml-">
